            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <ul class="footer__list">
                        ...
                        <li class="footer__item"><a href="" onclick="return false;" data-micromodal-trigger="avaliacao-digital" >vender</a></li>
...
-->
    ...
    <div class="modal micromodal-slide" id="sucesso" aria-hidden="true">
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="sucesso-title">
                <header class="modal__header">
                    <button class="modal__close" aria-label="Close modal" data-micromodal-close></button>
                </header>
                <main class="modal__content" id="sucesso-content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
    ...
    <div class="modal micromodal-slide" id="contato" aria-hidden="true">
        <div class="modal__overlay" tabindex="-1">
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="contato-title">
                <header class="modal__header">
                    <button class="modal__close" aria-label="Close modal" data-micromodal-close></button>
                </header>
                <main class="modal__content" id="contato-content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
    ...
    <div class="modal micromodal-slide modal--small" id="avaliacao-digital" aria-hidden="true">
        <div class="modal__overlay" tabindex="-1">
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="avaliacao-digital-title">
                <header class="modal__header">
                    <button class="modal__close" aria-label="Close modal" data-micromodal-close></button>
                </header>
                <main class="modal__content" id="avaliacao-digital-content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
